...
namespace Sharp
{
    class Program
    {
        ...
        {
            Canvas.Draw(Example2HALF(),3000, new Canvas.Padding(0, 0, 0, 0),x=>
            {
                if (x)
        ...
        {
            return c1.Add(p1).Add(p2).Add(p3).Add(p8).Add(p4).Add(p5).Add(p6);
        }
        ...
        {
            return r1.Add(p1).Add(p2).Add(p8).Add(p3).Add(p4).Add(p5).Add(p6);
        }
