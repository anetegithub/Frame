    ...
    class Program
    {
        ...
        static Picture p1 = new Picture("0.jpg"),
               ...
               p6 = new Picture("5.jpg"),
                ...
                p8 = new Picture("7.gif");

        static void Main(string[] args)
        {
            Canvas.Draw(NotJustEasyRow(),3000, new Canvas.Padding(0, 0, 0, 0),x=>
            {
                if (x)
        ...
        /// </summary>
        /// <returns></returns>
        static Element EasyCol()
        {
            return c1.Add(p1).Add(p2).Add(p3).Add(p4).Add(p5).Add(p6).Add(p7).Add(p8);
        }
        ...
        /// </summary>
        /// <returns></returns>
        static Element EasyRow()
        {
            return r1.Add(p1).Add(p2).Add(p8).Add(p3).Add(p4).Add(p5).Add(p6).Add(p7);
        }

        static Element NotJustEasyRow()
        {
            c1.Add(p7).Add(p7);

            return r1.Add(p1).Add(p2).Add(p3).Add(c1).Add(p5).Add(p6).Add(p4).Add(p7);
        }
        ...
        ///// </summary>
        ///// <returns></returns>
        //static IElement Example2HALF()
        //{
        //    r1.Add(p1).Add(c1).Add(c2).Add(p5);
        //    c2.Add(p6).Add(p5);
        //    c1.Identificator = "col1";
        //    c1.Add(r2).Add(r3).Add(p8);
        //    r2.Add(c3).Add(p3);
        //    //c3.Add(r4).Add(p1);
        //    //r4.Add(p1).Add(p1);
        //    //r3.Add(p8).Add(c4).Add(c5);
